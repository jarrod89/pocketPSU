...
// Function to remove the highlight after update
...
void setup() {
    ...
    lv_obj_align(voltage_limit_ch2_label, LV_ALIGN_TOP_LEFT, 10, 70);  // Position the label
    ...
    lv_obj_align(current_limit_ch2_label, LV_ALIGN_TOP_LEFT, 10, 100);  // Position the label
}
